  ...
  return (
      ...
      <div className="flex-1">
        ...
        <main className="p-8">
          ...
          <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-3xl p-10 mt-10 shadow-lg">
...
function InfoCard({
  ...
  return (
    <div className="bg-gray-100 dark:bg-slate-800 rounded-xl p-5">
      ...
      <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-2 break-all">
        {value}
      </h3>
